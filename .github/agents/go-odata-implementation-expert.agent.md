...
2. If a change is purely internal refactoring with no protocol impact, skip the delegation and state why.
...
5. Return a concise report of changes, validation, and any remaining risks.
