...
// Note: ProductIDs will be set during seeding after products are created
func GetSampleProductDescriptions() []ProductDescription {
	return []ProductDescription{
		...
		{
			ProductID:   uuid.Nil, // Will be set during seeding to second product (Wireless Mouse)
			LanguageKey: "EN",
		...
		{
			ProductID:   uuid.Nil, // Will be set during seeding to third product (Coffee Mug)
			LanguageKey: "EN",
		...
		{
			ProductID:   uuid.Nil, // Will be set during seeding to fifth product (Smartphone)
			LanguageKey: "EN",
