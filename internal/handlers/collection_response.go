...
func (h *EntityHandler) collectionResponseWriterImpl(w http.ResponseWriter, r *http.Request, pref *preference.Preference, queryOptions *query.QueryOptions, results interface{}, totalCount *int64, nextLink *string) error {
