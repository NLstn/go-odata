...
//
//  // ODataBeforeReadCollectionGeneric runs before a collection is fetched and can reject the request.
//  func (Product) ODataBeforeReadCollectionGeneric(ctx context.Context, r *http.Request, opts *odata.QueryOptions) error
//
//  // ODataAfterReadCollectionGeneric lets you replace or mutate the collection returned to the client.
...
//
//  // ODataBeforeReadEntityGeneric runs before a single entity is fetched and can reject the request.
//  func (Product) ODataBeforeReadEntityGeneric(ctx context.Context, r *http.Request, opts *odata.QueryOptions) error
//
//  // ODataAfterReadEntityGeneric lets you replace or mutate the entity returned to the client.
...
// After* hooks receive the fetched data and can return a replacement value. In every case, returning a
// non-nil error aborts the request processing with that error.
