...
func TestParseAnnotationTag(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "mismatched quotes - double to single",
			tag:         "Core.Description=\"text'",
			expectError: true,
		},
		{
			name:        "mismatched quotes - single to double",
			tag:         "Core.Description='text\"",
			expectError: true,
		},
		{
		...
		{
			name:              "float with leading decimal",
			tag:               "Core.Permissions=.5",
			expectedTerm:      "Org.OData.Core.V1.Permissions",
			expectedQualifier: "",
			expectedValue:     0.5,
		},
		{
			name:              "float with trailing decimal",
			tag:               "Core.Permissions=5.",
			expectedTerm:      "Org.OData.Core.V1.Permissions",
			expectedQualifier: "",
			expectedValue:     5.0,
		...
		},
		{
			...
			tag:               "Core.Description='123'",
			expectedTerm:      "Org.OData.Core.V1.Description",
			expectedQualifier: "",
			expectedValue:     "123",
		},
		{
			name:              "single-quoted boolean string",
			tag:               "Core.Description='true'",
			expectedTerm:      "Org.OData.Core.V1.Description",
			expectedQualifier: "",
			expectedValue:     "true",
		...
		{
			name:        "invalid numeric with multiple e",
			tag:         "Core.Permissions=1e2e3",
			expectError: true,
		},
		{
			name:        "invalid numeric - incomplete exponent",
			tag:         "Core.Permissions=1e",
			expectError: true,
		},
		{
			name:              "escaped quote in double-quoted string",
			tag:               "Core.Description=\"He said \\\"hello\\\"\"",
			expectedTerm:      "Org.OData.Core.V1.Description",
			expectedQualifier: "",
		...
		},
		{
			...
			tag:               "Core.Description='It\\'s working'",
			expectedTerm:      "Org.OData.Core.V1.Description",
			expectedQualifier: "",
		...
		},
		{
			...
			tag:               "Core.Description=\"path\\\\file\"",
			expectedTerm:      "Org.OData.Core.V1.Description",
			expectedQualifier: "",
			expectedValue:     "path\\file",
		},
		{
			name:              "escaped newline",
			tag:               "Core.Description=\"line1\\nline2\"",
			expectedTerm:      "Org.OData.Core.V1.Description",
			expectedQualifier: "",
			expectedValue:     "line1\nline2",
		},
		{
			...
			tag:         "Core.Description=\"trailing\\",
			expectError: true,
		},
		{
			name:        "unexpected characters after closing quote",
			tag:         "Core.Description=\"value\"extra",
			expectError: true,
		},
		{
			name:              "case insensitive boolean TRUE",
			tag:               "Core.Computed=TRUE",
			expectedTerm:      "Org.OData.Core.V1.Computed",
			expectedQualifier: "",
			expectedValue:     true,
		...
		{
			name:              "case insensitive boolean False",
			tag:               "Core.Computed=False",
			expectedTerm:      "Org.OData.Core.V1.Computed",
			expectedQualifier: "",
			expectedValue:     false,
