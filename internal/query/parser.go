...
const (
	...
	OpFractionalSeconds  FilterOperator = "fractionalseconds"
	OpTotalOffsetMinutes FilterOperator = "totaloffsetminutes"
	OpTotalSeconds       FilterOperator = "totalseconds"
	OpMinDatetime        FilterOperator = "mindatetime"
	OpMaxDatetime        FilterOperator = "maxdatetime"
	// Lambda operators
